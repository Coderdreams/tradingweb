...
void HTTPServerTest::testTransactions()
{
	...
	CPPUNIT_ASSERT_EQUAL(result1->getValue<std::string>("price"), std::string("57.939999"));
	...
	CPPUNIT_ASSERT_EQUAL(result2->getValue<std::string>("price"), std::string("57.939999"));
...
void HTTPServerTest::testPortfolio()
{
	...
	CPPUNIT_ASSERT_EQUAL(result1->getValue<std::string>("cost"), std::string("463.519958"));
